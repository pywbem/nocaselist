#
# Sphinx config file for nocaselist project.
#
...
version = get_version(os.path.join('..', 'nocaselist', '_version.py'))
...
htmlhelp_basename = 'nocaselist_doc'
...
latex_documents = [
    (master_doc, 'nocaselist.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'nocaselist', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nocaselist', _short_description,
     author, 'nocaselist', _short_description,
     'Miscellaneous'),
]
