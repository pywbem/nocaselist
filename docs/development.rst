...
Python environment.
Depending on how the `nocaselist` package is installed in
...
This section describes how to release a version of nocaselist
to PyPI.
...
17. Upload the package to PyPI:
    ...
    **Attention!!** This only works once. You cannot re-release the same
    ...
    Verify that it arrived on PyPI: https://pypi.python.org/pypi/nocaselist/

Starting a new version
----------------------

This section shows the steps for starting development of a new version of the
nocaselist project in its Git repo.
...
5.  Edit the change log:
    ...
    .. code-block:: text
        ...
        nocaselist 0.2.0.dev1
        ------------------------------------------

        This version contains all fixes up to nocaselist 0.1.x.
