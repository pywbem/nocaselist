...
project package at https://nocaselist.readthedocs.io/
...
`Dependabot alerts <https://github.com/pywbem/nocaselist/security/dependabot>`_
and the creation of
`Dependabot pull requests <https:/github.com/pywbem/nocaselist/pulls?q=is%3Apr+label%3Adependencies+is%3Aopen>`_
to fix them.
...
look at the
`run of the backport workflow <https:/github.com/pywbem/nocaselist/actions/workflows/backport.yml>`_
...
at https://github.com/pywbem/nocaselist and that the remote repo
has the remote name ``origin`` in your local clone.

Any commands in the following steps are executed in the main directory of your
local clone of the ``pywbem/nocaselist`` Git repo.
...
10. Verify the publishing
    ...
    https://github.com/pywbem/nocaselist/actions/workflows/publish.yml
    ...
    * Verify that the new version has a release on Github at
      https://github.com/pywbem/nocaselist/releases

    * Verify that the new version has documentation on ReadTheDocs at
      https://nocaselist.readthedocs.io/en/stable/changes.html
      ...
      https://readthedocs.org/projects/nocaselist/versions/ and activate
      the new version.
